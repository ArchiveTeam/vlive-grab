...
LUA_SHA1 = get_hash(os.path.join(CWD, 'vlive.lua'))
...
project = Project(
    title='VLIVE',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/c/cd/Vlive-icon.png" height="50px" title=""/>
        <h2>vlive.tv <span class="links"><a href="https://vlive.tv/">Website</a> &middot; <a href="http://tracker.archiveteam.org/vlive/">Leaderboard</a></span></h2>
        <p>Archiving VLIVE.</p>
    '''
)
